...
public class CssDescription implements LanguageDescription {
	...
	public String[] getKeywords() {
		...
		return new String[]{
			...
			"radius","grid-template","grid","grid-area","grid-auto-columns","grid-auto-flow","grid-auto-rows","grid-column","grid-column-end","grid-column-start","grid-gap","grid-row-gap","grid-column-gap","grid-row-start","grid-template-columns"
