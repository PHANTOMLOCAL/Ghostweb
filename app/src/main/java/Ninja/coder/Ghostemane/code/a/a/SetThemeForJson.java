...
public class SetThemeForJson {
	...
	public SetThemeForJson setThemeCodeEditor(CodeEditor editor, HashMap<String, Object> imap, boolean chackHashMap,Activity x) {
		...
		if (imap.containsKey("AUTO_COMP_PANEL_BG")) {
			...
			editor.getColorScheme().setColor(EditorColorScheme.AUTO_COMP_PANEL_BG, Color.parseColor("#FF2B2121"));
			dialogError(x);
		}
		...
		if (imap.containsKey("LINE_NUMBER_BACKGROUND")) {
			...
			editor.getColorScheme().setColor(EditorColorScheme.LINE_NUMBER_BACKGROUND, Color.parseColor("#FF2B2121"));
			dialogError(x);
		}
		if (imap.containsKey("WHOLE_BACKGROUND")) {
			...
			editor.getColorScheme().setColor(EditorColorScheme.WHOLE_BACKGROUND, Color.parseColor("#FF2B2121"));
			dialogError(x);
		}
