...
public class PythonLexer extends PythonLexerBase {
	...
	CLOSE_BRACKET = 95, NAME = 96, LINE_JOIN = 97, NEWLINE = 98, WS = 99, COMMENT = 100 , INT = 101,INPUT = 102;
	...
	private static String[] makeRuleNames() {
		return new String[]{
			...
			"LONG_BYTES_CHAR", "BYTES_ESCAPE_SEQ", "ID_CONTINUE", "ID_START","PRINT","INT","INPUT"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[]{
			...
			"NAME", "LINE_JOIN", "NEWLINE", "WS", "COMMENT","INT","INPUT"
		};
	}
